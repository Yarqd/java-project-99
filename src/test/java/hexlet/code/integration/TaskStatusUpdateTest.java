...
//        // Проверяем, что зависимости успешно инициализированы
//        assertNotNull(mockMvc, "MockMvc is not initialized");
//        assertNotNull(taskStatusRepository, "TaskStatusRepository is not initialized");
//        assertNotNull(userRepository, "UserRepository is not initialized");
//        assertNotNull(objectMapper, "ObjectMapper is not initialized");
//        assertNotNull(passwordEncoder, "BCryptPasswordEncoder is not initialized");
//
//        // Регистрируем модуль для работы с JavaTime
//        objectMapper.registerModule(new JavaTimeModule());
//        testUtils = new TestUtils(objectMapper);
//
//        // Очищаем данные в базе
...
//        jwtToken = "Bearer " + responseBody.trim();
//
...
//        // Проверяем, что jwtToken и taskStatus успешно инициализированы
//        assertNotNull(jwtToken, "JWT token is not initialized");
//        assertNotNull(taskStatus, "TaskStatus is not initialized");
//
